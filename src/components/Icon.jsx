...
const ICONS = {
  ...
  share: () => (
    <>
      {P('M12 15.4V4.2')}
      {P('M7.8 8.4 12 4.2l4.2 4.2')}
      {P('M5.6 12.6v6.2a1.4 1.4 0 0 0 1.4 1.4h10a1.4 1.4 0 0 0 1.4-1.4v-6.2')}
    </>
  ),
  food: () => (
    <>
      {P('M7 3.6v6.2M4.6 3.6v3.6a2.4 2.4 0 0 0 4.8 0V3.6')}
      {P('M7 9.8v10.6')}
      {P('M16.6 14.2V3.8c-2.2 1-3.4 3.4-3.4 6.2 0 2 .8 3.4 2 4.2z')}
      {P('M16.6 14.2v6.2')}
    </>
  ),
  cloud: () => P('M6.6 18.4a4 4 0 0 1-.6-7.9 5.4 5.4 0 0 1 10.5-1.2 4.4 4.4 0 0 1-.7 8.8z'),
  rain: () => (
    <>
      {P('M6.6 14.8a4 4 0 0 1-.6-7.9 5.4 5.4 0 0 1 10.5-1.2 4.4 4.4 0 0 1-.7 8.8')}
      {P('M8.4 17.4l-1 3M12.4 17.4l-1 3M16.4 17.4l-1 3')}
    </>
  ),
  snow: () => (
    <>
      {P('M6.6 14.8a4 4 0 0 1-.6-7.9 5.4 5.4 0 0 1 10.5-1.2 4.4 4.4 0 0 1-.7 8.8')}
      {C(8, 18.4, 0.5, { fill: 'currentColor' })}
      {C(12, 19.8, 0.5, { fill: 'currentColor' })}
      {C(16, 18.4, 0.5, { fill: 'currentColor' })}
    </>
  ),
  storm: () => (
    <>
      {P('M6.6 14.2a4 4 0 0 1-.6-7.9 5.4 5.4 0 0 1 10.5-1.2 4.4 4.4 0 0 1-.7 8.8')}
      {P('M12.6 12.6 10 17h3l-1.6 4')}
    </>
  ),
  fog: () => (
    <>
      {P('M6.6 12.4a4 4 0 0 1-.6-7.9 5.4 5.4 0 0 1 10.5-1.2 4.4 4.4 0 0 1-.7 8.8')}
      {P('M5 15.6h14M7 18.6h10M9 21.4h6')}
    </>
  ),
  wind: () => (
    <>
      {P('M3.4 8.6h9.8a2.6 2.6 0 1 0-2.6-2.6')}
      {P('M3.4 12.6h14.8a2.6 2.6 0 1 1-2.6 2.6')}
      {P('M3.4 16.6h6.8a2.2 2.2 0 1 1-2.2 2.2')}
    </>
  ),
  crosshair: () => (
    <>
